...
$sql = "INSERT INTO MATRICULA (matricula_aluno, semestre, num_turma, ano, cod_disciplina, nota, frequencia)
        VALUES (:matricula_aluno, :semestre, :num_turma, :ano, :cod_disciplina, :nota, :frequencia)";
...
if (oci_execute($stmt)) {
    ob_clean();
    echo json_encode(['sucesso' => true, 'mensagem' => 'Matrícula cadastrada com sucesso']);
    exit;
} else {
