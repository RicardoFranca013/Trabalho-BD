...
$sql = "INSERT INTO DEPARTAMENTO (cod_departamento, nome_departamento, telefone, sala, bloco, campus)
        VALUES (:cod_departamento, :nome_departamento, :telefone, :sala, :bloco, :campus)";
...
if (oci_execute($stmt)) {
    ob_clean();
    echo json_encode(['sucesso' => true, 'mensagem' => 'Departamento cadastrado com sucesso']);
    exit;
} else {
