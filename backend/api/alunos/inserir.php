...
$sql = "INSERT INTO ALUNO (matricula, categoria, nome, data_nascimento, nivel, sexo, cod_curso, status, rendimento,
                            logradouro, bairro, cep, numero, estado, cidade)
        VALUES (:matricula, :categoria, :nome, TO_DATE(:data_nascimento, 'YYYY-MM-DD'), :nivel, :sexo, :cod_curso, :status, :rendimento,
                :logradouro, :bairro, :cep, :numero, :estado, :cidade)";
