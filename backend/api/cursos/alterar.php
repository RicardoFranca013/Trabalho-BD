...
$sql = "UPDATE CURSO
        SET nome = :nome, carga_horaria = :carga_horaria, cod_departamento = :cod_departamento,
            matricula_coordenador = :matricula_coordenador
...
if (oci_execute($stmt)) {
    ob_clean();
    echo json_encode(['sucesso' => true, 'mensagem' => 'Curso alterado com sucesso']);
    exit;
} else {
